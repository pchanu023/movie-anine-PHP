...
<body>
    ...
    <span style="color: #0056B3; text-decoration: underline;"><?php echo htmlspecialchars($username); ?></span>
            ...
            <h1>Fantasy Anime</h1> <!-- เพิ่มหัวข้อสำหรับหมวด Fantasy -->

            <div class="anime-grid">
                <?php
                // ดึงข้อมูลเฉพาะ anime ที่มี genreID = 1 (Fantasy)
                $sql = "SELECT id, title, image FROM anime WHERE genreID = 1"; // genreID = 1 หมายถึง Fantasy
